        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnFabricare = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Masini_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Producator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnFabricatie = table.Column<int>(type: "int", nullable: false),
                    Serie = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Descriere = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Piese_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DotareId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasinaDotari", x => new { x.MasinaId, x.DotareId });
                    table.ForeignKey(
                        name: "FK_MasinaDotari_Dotari_DotareId",
                        column: x => x.DotareId,
                        principalTable: "Dotari",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MasinaDotari_Masini_MasinaId",
                        column: x => x.MasinaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasinaDotari_DotareId",
                table: "MasinaDotari",
                column: "DotareId");

            migrationBuilder.CreateIndex(
                name: "IX_Masini_UserId",
                table: "Masini",
                column: "UserId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "Serie",
                unique: true,
                filter: "[Serie] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Piese_UserId",
                table: "Piese",
                column: "UserId");
